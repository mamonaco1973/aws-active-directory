...
echo "NOTE: Updating OS" >> /tmp/userdata.log

sudo apt update -y

echo "NOTE: Instaling packages" >> /tmp/userdata.log
...
echo "NOTE: Instaling AWS CLI" >> /tmp/userdata.log
...
echo "NOTE: Join active directory" >> /tmp/userdata.log
...
echo "NOTE: Tweak SSSD and SSHD configurations" >> /tmp/userdata.log
